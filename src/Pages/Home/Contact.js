...
export default function Contact() {
    return (
        <div className="space-y-5 bg-[url('https://raw.githubusercontent.com/ProgrammingHero1/doctors-portal/main/assets/images/appointment.png')] lg:p-5 p-2">
            ...
            <form class='flex items-center justify-center flex-col space-y-4' onSubmit={e => {
                e.preventDefault()
                ...
                <input name='message' type="text" placeholder="Subject" class="input input-bordered w-full max-w-xs" required />
                <textarea class="textarea w-full max-w-xs" placeholder="Your message" required></textarea>
